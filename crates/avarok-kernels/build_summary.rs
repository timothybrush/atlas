...
// — 196 — had to be dug out of `target/release/build/avarok-kernels-*/output`
...
/// `avarok-kernels: <N> kernels (<hw>, <model>, <quant>), <M> model-dir kernels, <K> declared overrides`
///
...
pub(crate) fn summary(
    ...
    format!(
        "avarok-kernels: {n_kernels} kernels ({hw}, {model}, {quant}), \
...
/// `build_defaults::read_defaults` — this also runs on the `AVAROK_SKIP_BUILD`
