...
pub struct TargetDefaults {
    ...
    /// per-sequence launches. It was `AVAROK_SSM_BATCHED_RECURRENT=1` in an
    ...
    /// `AVAROK_SSM_BA_GATES_HOPPER=0` is the A/B. Numbers:
    ...
    /// `AVAROK_FP8_ACT_QUANT_HOPPER=0` is the A/B. Numbers:
