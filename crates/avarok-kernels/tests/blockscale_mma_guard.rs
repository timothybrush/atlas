...
//! and `kernels/b200` compile sits inside `#ifndef AVAROK_NO_WARP_BLOCKSCALE_MMA`.
//!
...
const GUARD: &str = "AVAROK_NO_WARP_BLOCKSCALE_MMA";
...
/// Model directories under `kernels/<hw>` — the rule `AVAROK_TARGET_MODEL=*`
...
fn another_ifndef_is_not_the_guard() {
    let src = "\
#ifndef AVAROK_NO_WARP_BLOCKSCALE_MMA_V2
asm(\"cvt.rn.satfinite.e2m1x2.f32 b0, %2, %1;\");
#endif
";
