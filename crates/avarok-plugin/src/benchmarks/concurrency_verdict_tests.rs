...
//!
//! The essay-fixture tests at the end are here for the same cap: a third test
//! file would need a `gate::coverage` registry edit, which re-opens every gate.
...
// ── THE ESSAY FIXTURE — the published ladder38 request ───────────────────────
