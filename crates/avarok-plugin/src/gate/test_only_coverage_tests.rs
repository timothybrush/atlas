...
fn test_looking_neighbours_remain_fail_closed() {
    for path in [
        "crates/avarok-core/src/config/tests.rs.bak",
        "crates/avarok-core/src/config/tests/tests_b.rs",
        "crates/avarok-core/src/config/gguf/not_really_tests.rs",
        "crates/avarok-core/src/config/gguf.rs",
        "crates/avarok-core/src/config.rs",
        "crates/avarok-plugin/src/benchmarks/concurrency_tests.rs.bak",
        "crates/avarok-plugin/src/benchmarks/concurrency_tests/helper.rs",
    ] {
