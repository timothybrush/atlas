...
/// dlopens the library named by `AVAROK_GDN_LIB`, and a committed recipe fixture
...
/// excludes the whole `crates/avarok-plugin/src/gate` prefix from every gate,
...
/// only an unrelated `avarok-kernels` file as invalidating. It read red purely
/// by accident.
///
...
pub const BOUNDARY_FILES: [&str; 14] = [
    ...
    "crates/avarok-plugin/src/gate/required.rs",
    ...
    "crates/avarok-plugin/src/gate/check.rs",
    ...
    "crates/avarok-plugin/src/gate/check_paths.rs",
    ...
    "crates/avarok-plugin/src/gate/check_group.rs",
    ...
    "crates/avarok-plugin/src/gate/agreement.rs",
    ...
    "crates/avarok-plugin/src/gate/hermetic.rs",
    ...
    "crates/avarok-plugin/src/gate/amnesty.rs",
    ...
    "crates/avarok-plugin/src/gate/group.rs",
];
...
const GATE_MACHINERY_FILES: &[&str] = &[
    ...
    "crates/avarok-plugin/src/gate/telemetry.rs",
    "crates/avarok-plugin/src/gate/telemetry_order.rs",
    // Ownership resolution for the telemetry table; no gate consults it.
    "crates/avarok-plugin/src/gate/codeowners.rs",
    ...
    "crates/avarok-plugin/src/gate/pr_taxonomy.rs",
    ...
    "crates/avarok-plugin/src/gate/signing.rs",
    // Test-only baseline fixtures.
    "crates/avarok-plugin/src/gate/fixture_baseline.rs",
    // Module wiring.
    "crates/avarok-plugin/src/gate/mod.rs",
...
pub const TEST_ONLY_RUST_MODULES: &[TestOnlyRustModule] = &[
    ...
    TestOnlyRustModule {
        path: "crates/avarok-core/src/config/tests.rs",
        parent: "crates/avarok-core/src/config.rs",
        name: "tests",
        declared_path: None,
    },
    TestOnlyRustModule {
        path: "crates/avarok-core/src/config/gguf/tests.rs",
        parent: "crates/avarok-core/src/config/gguf.rs",
        name: "tests",
        declared_path: None,
    },
    TestOnlyRustModule {
        path: "crates/avarok-core/src/config/parsers/lora_tests.rs",
        parent: "crates/avarok-core/src/config/parsers/lora.rs",
        name: "tests",
        declared_path: Some("lora_tests.rs"),
    },
    TestOnlyRustModule {
        path: "crates/avarok-plugin/src/benchmarks/concurrency_tests.rs",
    ...
    TestOnlyRustModule {
        path: "crates/avarok-plugin/src/benchmarks/concurrency_verdict_tests.rs",
        parent: "crates/avarok-plugin/src/benchmarks/concurrency.rs",
...
const GATE_MACHINERY: Exclusion = Exclusion {
    prefix: "crates/avarok-plugin/src/gate",
...
const TTFT_EXCLUDES: &[Exclusion] = &[
    ...
    other_driver(
        "crates/avarok-plugin/src/benchmarks/kat_equality",
...
const BFCL_EXCLUDES: &[Exclusion] = &[
    GATE_MACHINERY,
    other_driver(
        "crates/avarok-plugin/src/benchmarks/ttft",
