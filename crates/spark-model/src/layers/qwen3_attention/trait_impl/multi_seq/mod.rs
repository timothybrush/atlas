...
//! - `qkv_fp8_batch` — phase 2 tier: batched native-FP8 Q/K/V (n in 2..=16)
//! - `w8a8_decode`   — phase 2/6 tier: W8A8 cuBLASLt Q/K/V/O (n in 5..=16)
...
mod qkv;
mod qkv_fp8_batch;
// W8A8 block-scaled cuBLASLt arm for the 5..16-row decode projections (#927).
mod w8a8_decode;
