...
// Paged Decode Attention — Asymmetric K=bf16, V=turbo3 (HDIM=256).
//
...
// HDIM=256: 4 values per thread per group (even/odd lane split).
...
extern "C" __global__ void paged_decode_attn_bf16k_turbo3v(
    ...
    // Paired threads share 3 bytes for 8 values (HDIM=256); HDIM=256 covers
