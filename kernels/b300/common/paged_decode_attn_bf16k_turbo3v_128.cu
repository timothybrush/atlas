...
// Paged Decode Attention — Asymmetric K=bf16, V=turbo3 (HDIM=128).
//
// TurboQuant+ safer-asym variant: K kept at full BF16 precision (preserves
// attention-score fidelity), V compressed to 3-bit Lloyd-Max + per-group FP8
...
// ============================================================================
// Asymmetric Bf16K + Turbo3V paged decode attention
// ============================================================================
extern "C" __global__ void paged_decode_attn_bf16k_turbo3v(
